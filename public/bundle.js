...
},{"./newsFeed/newsHTMLFactory":5}],3:[function(require,module,exports){
"use strict";
...
const newsHTMLFactory = () => _newsAPIHandler.default.getNews().then(parsedNews => {
  ...
  _newsEventListenerHandler.default.removeArticleButton(); //clear the DOM before adding articles


  articleContainer.innerHTML = ""; //loop through array of articles and make html

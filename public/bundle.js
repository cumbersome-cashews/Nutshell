...
var _navbarHTML = _interopRequireDefault(require("./navbar/navbarHTML"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _navbarHTML.default)();

_welcome.default.welcome(_welcomeForms.default.loginForm);

_welcomeEventHandler.default.all();

},{"./navbar/navbarHTML":3,"./welcome/welcome":10,"./welcome/welcomeEventHandler":12,"./welcome/welcomeForms":13}],3:[function(require,module,exports){
"use strict";
...
const apiHandler = {
  getNews: userId => {
    return fetch(`http://localhost:8088/articles?_expand=user&userId=${userId}`).then(res => res.json());
  },
  getOneArticle: id => {
...
var _newsInputForm = _interopRequireDefault(require("./newsInputForm"));

var _newsAPIHandler = _interopRequireDefault(require("./newsAPIHandler"));

var _newsHTMLFactory = _interopRequireDefault(require("./newsHTMLFactory"));
  ...
  inputContainer(activeUserId) {
    ...
    $("#newsFeed-input-container").addEventListener("click", e => {
      if (e.target.id === "createInputButton") {
        _newsPrintToDom.default.printInputField(_newsInputForm.default.newsInputForm, "#newsFeed-input-container"); //save new article to database
        ...
        const url = $("#newsURLInput").value; //verify the form is filled
        ...
        if (title !== "" && summary !== "" && url !== "") {
          ...
          const newsObject = {
            ...
            "summary": summary,
            "url": url,
            "timestamp": Date.now() //post new object to database

          };

          _newsAPIHandler.default.postNews(activeUserId, newsObject).then(() => {
            (0, _newsHTMLFactory.default)(activeUserId);
          });
        ...
        const articleId = parseInt(stringArticleId); //create new object
        ...
        const newsObject = {
          ...
          "summary": summary,
          "url": url,
          "timestamp": Date.now() //replace object in database

        };

        _newsAPIHandler.default.editNews(articleId, newsObject).then(() => {
          $("#newsFeed-article-container").innerHTML = "";
          (0, _newsHTMLFactory.default)(activeUserId);
        }); //cancel new post

      } else if (e.target.id === "cancelPost") {
        _newsPrintToDom.default.printInputField(_newsInputForm.default.postNewArticleHTML, "#newsFeed-input-container");
      }
    });
  },
  ...
  articleContainer(activeUserId) {
    ...
    $("#newsFeed-article-container").addEventListener("click", e => {
      ...
      if (buttonId.includes("editArticle--")) {
        ...
        _newsPrintToDom.default.printInputField(_newsInputForm.default.newsInputForm, "#newsFeed-input-container");

        const articleId = buttonId.split("--")[1];
        $("#newsHiddenInput").value = parseInt(articleId); //change post button text to save

        $("#postArticleButton").textContent = "Save";
        $("#newsInputContainer").classList.add('newsArticleEdit'); //grab that object from API and prefill form

        _newsAPIHandler.default.getOneArticle(parseInt(articleId)).then(article => {
        ...
        if (deleteConfirmation === true) {
          ...
          _newsAPIHandler.default.deleteNews(articleId).then(() => {
            (0, _newsHTMLFactory.default)(activeUserId);
          });
        }
      }
...
var _default = newsEventListener;
exports.default = _default;

},{"./newsAPIHandler":4,"./newsHTMLFactory":6,"./newsInputForm":7,"./newsPrintToDom":8}],6:[function(require,module,exports){
"use strict";
...
const $ = document.querySelector.bind(document);
const articleContainer = $("#newsFeed-article-container"); //create and print "post new article" button

const newsHTMLFactory = activeUserId => {
  _newsPrintToDom.default.printInputField(_newsInputForm.default.postNewArticleHTML, "#newsFeed-input-container"); //clear the DOM before adding articles


  articleContainer.innerHTML = ""; //fetch all articles from database

  _newsAPIHandler.default.getNews(activeUserId).then(parsedNews => {
    const revParsedNews = parsedNews.reverse(); //loop through array of articles and make html
    ...
    revParsedNews.forEach(news => {
      ...
      let newsLinkShortener = news.url.split("/")[2]; //build article html
...
`; //print saved articles to DOM
      ...
      _newsPrintToDom.default.printArticles(newsHTML, "#newsFeed-article-container");
    });
  });
};

var _default = newsHTMLFactory;
exports.default = _default;

},{"./newsAPIHandler":4,"./newsInputForm":7,"./newsPrintToDom":8,"moment":1}],7:[function(require,module,exports){
"use strict";
...
var _newsHTMLFactory = _interopRequireDefault(require("../newsFeed/newsHTMLFactory"));

var _newsEventListenerHandler = _interopRequireDefault(require("../newsFeed/newsEventListenerHandler"));
...
const welcome = {
  ...
  showDashboard: activeUserId => {
    ...
    _newsEventListenerHandler.default.inputContainer(activeUserId);

    _newsEventListenerHandler.default.articleContainer(activeUserId);
  }
};
var _default = welcome;
exports.default = _default;

},{"../newsFeed/newsEventListenerHandler":5,"../newsFeed/newsHTMLFactory":6,"./printToDOM":9,"./welcomeApiManager":11,"./welcomeForms":13}],11:[function(require,module,exports){
"use strict";
...
},{"./welcome":10,"./welcomeForms":13}],13:[function(require,module,exports){
"use strict";

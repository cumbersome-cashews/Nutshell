  ...
  articleContainer() {
    ...
    $("#newsFeed-article-container").addEventListener("click", e => {
      ...
      if (buttonId.includes("editArticle--")) {
        ...
        $("#postArticleButton").textContent = "Save"; //grab that object from API and prefill form

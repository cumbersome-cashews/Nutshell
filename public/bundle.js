...
const apiHandler = {
  getNews: () => {
    return fetch(`http://localhost:8088/articles?_expand=user`).then(res => res.json());
  },
  getOneArticle: id => {

...
_newsEventListenerHandler.default.newsInputButton();

_newsEventListenerHandler.default.postArticleButton();

_newsEventListenerHandler.default.editArticleButton();
  ...
  editArticleButton() {
    $("#newsFeed-article-container").addEventListener("click", e => {
      ...
      if (buttonId.includes("editArticle--")) {
        ...
        let deleteConfirmation = confirm("Are you sure you want to do that?");
...
var _newsEventListenerHandler = _interopRequireDefault(require("./newsEventListenerHandler"));
...
},{"./newsAPIHandler":3,"./newsEventListenerHandler":4,"./newsInputForm":6,"./newsPrintToDom":7,"moment":1}],6:[function(require,module,exports){
"use strict";

...
},{"./newsFeed/newsHTMLFactory":4}],3:[function(require,module,exports){
"use strict";
...
const newsHTMLFactory = () => _newsAPIHandler.default.newsApi().then(parsedNews => {
  parsedNews.forEach(news => {
    ...
    `;
    (0, _newsPrintToDom.default)(newsHTML);
  });
...
},{"./newsAPIHandler":3,"./newsPrintToDom":5,"moment":1}],5:[function(require,module,exports){
"use strict";

  ...
  postArticleButton() {
    $("#newsFeed-input-container").addEventListener("click", e => {
      if (e.target.id === "postArticleButton" && $("#hiddenInput").value === "") {
        ...
        _newsAPIHandler.default.postNews(newsObject).then(_newsPrintToDom.default.printInputField(_newsInputForm.default.postNewArticleHTML, "#newsFeed-input-container"));
      } else {
        if (e.target.id === "postArticleButton" && $("#hiddenInput").value !== "") {
          const title = $("#newsTitleInput").value;
          const summary = $("#newsSynopsisInput").value;
          ...
          _newsAPIHandler.default.editNews(articleId, newsObject).then(_newsPrintToDom.default.printInputField(_newsInputForm.default.postNewArticleHTML, "#newsFeed-input-container"));
        }
      }
    });
  },
  ...
  removeArticleButton() {
    $("#newsFeed-article-container").addEventListener("click", e => {
      ...
      if (buttonId.includes("removeArticle--")) {
        ...
        _newsAPIHandler.default.deleteNews(articleId);
      }
    });
  }
...
},{"./newsAPIHandler":3,"./newsInputForm":6,"./newsPrintToDom":7}],5:[function(require,module,exports){
"use strict";
...
const newsHTMLFactory = () => _newsAPIHandler.default.getNews().then(parsedNews => {
  ...
  _newsEventListenerHandler.default.removeArticleButton(); //loop through array of articles and make html
